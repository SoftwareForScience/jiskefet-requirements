...
\begin{enumerate}
  ...
  \item As run co\"ordinator I want to be able to revert a changed EOR reason to the original.
...
\begin{itemize}
  ...
  \item Data taking should not stop if access to repositories is interrupted
\end{itemize}
